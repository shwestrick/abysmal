structure AfterWhileElaboration =
struct
  ...
  (** =========================================================================
    * Types.
    *
    * Changes from AfterFnElaboration: none.
    *)
  structure Ty =
  struct
    datatype ty =
  ...
  (** =========================================================================
    ...
    *
    * Changes from AfterFnElaboration:
    *   - While removed (rewritten to let val rec _loop = fn () => ... in _loop () end)
    *)
  structure Exp =
  struct
