...
struct
  ...
  (** =========================================================================
    * Types.
    *
    * Changes from AfterFunElaboration: none.
    *)
  structure Ty =
  struct
    datatype ty =
  ...
  (** =========================================================================
    ...
    *
    * Changes from AfterFunElaboration:
    *   - Fn simplified: elems seq replaced by single pat and exp
    *)
  structure Exp =
  struct
