      ...
      fun synth (origin: NodeID.t) (why: string) : NodeID.t =
        ...
        in
          emit (id, ProvenanceEvent.Synthesized
            {id = id, pass = "boolean-elaboration", origin = origin, why = why});
          id
        end
      ...
      and conv_exp exp =
        ...
        | R.Exp.Andalso {id, left, right} =>
            A.Exp.Case
              ...
              , exp = conv_exp left
              , elems = Seq.%
                  [ {pat = true_pat id, exp = conv_exp right}
                  , {pat = wild_pat id, exp = false_exp id}
                  ]
              }
        ...
        | R.Exp.Orelse {id, left, right} =>
            A.Exp.Case
              ...
              , exp = conv_exp left
              , elems = Seq.%
                  [ {pat = true_pat id, exp = true_exp id}
                  , {pat = wild_pat id, exp = conv_exp right}
                  ]
              }
        ...
        | R.Exp.IfThenElse {id, exp1, exp2, exp3} =>
            A.Exp.Case
              ...
              , exp = conv_exp exp1
              , elems = Seq.%
                  [ {pat = true_pat id, exp = conv_exp exp2}
                  , {pat = wild_pat id, exp = conv_exp exp3}
                  ]
              }
