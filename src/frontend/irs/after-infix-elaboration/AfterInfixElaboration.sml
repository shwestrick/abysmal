structure AfterInfixElaboration =
struct
  ...
  (** =========================================================================
    * Types.
    *
    * Changes from AfterBooleanElaboration: none.
    *)
  structure Ty =
  struct
    datatype ty =
  ...
  (** =========================================================================
    * Patterns.
    *
    * Changes from AfterBooleanElaboration:
    *   - Pat.Infix removed (rewritten to Pat.Con on pair record)
    *   - has_op removed from Ident, Con, Layered
    *)
  structure Pat =
  struct
  ...
  (** =========================================================================
    ...
    *
    * Changes from AfterBooleanElaboration:
    *   - Exp.Infix removed (rewritten to App on pair record)
    *   - has_op removed from Exp.Ident
    *   - fname_args simplified: InfixedFun and CurriedInfixedFun removed,
    *     PrefixedFun collapsed to plain record type; has_op removed
    *   - has_op removed from ExnNew, ExnReplicate
    *   - DecInfix, DecInfixr, DecNonfix removed
    *)
  structure Exp =
  struct
    ...
    type fname_args = {id: node_id, name: string, args: Pat.t Seq.t}
