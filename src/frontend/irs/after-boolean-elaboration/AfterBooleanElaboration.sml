structure AfterBooleanElaboration =
struct
  ...
  (** =========================================================================
    * Types.
    *
    * Changes from AfterRecordUnification: none.
    *)
  structure Ty =
  struct
    datatype ty =
  ...
  (** =========================================================================
    ...
    *
    * Changes from AfterRecordUnification:
    *   - Andalso removed (elaborated to Case on true/false)
    *   - Orelse  removed (elaborated to Case on true/false)
    *   - IfThenElse removed (elaborated to Case on true/false)
    *)
  structure Exp =
  struct
